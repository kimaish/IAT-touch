    ...
    **/
    ...
    function iatExtension(options) {
        ...
        var iatObj = {
            ...
            finalText: 'अगले कार्य को जारी रखने के लिए स्पेस दबाए',
            ...
            instAttributePracticeTouch: [
                ...
                'दाहिनी उंगली रखें <b> दाहिने </b> हरे क्षेत्र पर उन वस्तुओं के लिए जो श्रेणी से संबंधित हैं  <font color="#0000ff">rightAttribute</font>.<br/>',
            ...
            instSwitchCategories: '<div><p align="center" style="font-size:20px; font-family:arial">' +
                ...
                'दाहिनी उंगली का प्रयोग करें <b>I</b> बटन पर <font color="#336600">rightCategory</font>.<br/><br/> के लिए ' +
        ...
        function getLayout(params) {
            ...
            if (!params.isInst && params.remindError) {
                layout.push({
                    ...
                    media: {
                        html: isTouch ? params.remindErrorTextTouch : params.remindErrorText
                    }
                });
            }
