...
title : {
media : {word : 'Black people'}, //Name of the
category presented in the task.
css : {color:'#336600','font-size':'1.8em'}, //Style of
the category title.
...
default feedback message.
title : {
media : {word : 'White people'}, //Name of the
category presented in the task.
css : {color:'#336600','font-size':'1.8em'}, //Style of
the category title.
height : 4 //Used to position the "Or" in the
...
IAT, change blockSecondCombined_nTrials to 0.
...
'আপনি যনি ভুল করেি, একটি লাল <font color="#ff0000"><b>X</b></font>
দিখা যারে. ' +
চানলর়ে দযরে অিয কী টিপুি।<p/>',
remindErrorTextTouch : '<p align="center" style="fontsize:"1.4em"; font-family:arial">' +
' আপনি যনি ভুল করেি, একটি লাল <font color="#ff0000"><b>X</b></font>
দিখা যারে। ' +
' চানলর়ে দযরে অিয নিরক স্পর্শকরুি.<p/>',
...
keysCss : {'font-size':'0.8em', 'font-family':'courier',
color:'#000000'},
...
finalText : ' পেেেী কাজ চানলর়ে দযরে দস্পস টিপুি ',
finalTouchText : ' পেেেী কাজ চানলর়ে দযরে িীরচে সেুজ এলাকা়ে স্পর্শকরুি ',
...
' <font color="#0000ff">leftAttribute</font>' কযাটাগনেে
অন্তগশে আইরটমগুনলে জিয <b>E</b> কীটিরে একটি োাঁআঙু ল োখুি। +
'<br/> <font color="#0000ff">rightAttribute</font>
কযাটাগনেে অন্তগশে আইরটমগুনলে জিয <b>I</b> কীটিরে ডাি আঙু ল োখুি।<br/><br/>' +
' আপনি যনি ভুল করেি, একটি লাল <font
color="#ff0000"><b>X</b></font> দিখা যারে। ' +
' চানলর়ে দযরে অিয কী টিপুি.<br/>' +
'<u> নিভুশল থাকাকালীি আপনি যে োডাোনড পারেি</u>
যাি.<br/><br/></p>'+
'<p align="center"> আপনি যখি শুরু কেরে প্রস্তুে েখি <b>দস্পস
োে</b> টিপুি.</font></p></div>',
...
'<br/>',
' কযাটাগনেে অন্তগশে আইরটমগুনলে জিয <b> োাঁ</b> সেুজ
এলাকা়ে একটি োাঁআঙু ল োখুি <font color="#0000ff">leftAttribute</font>.<br/>',
' কযাটাগনেে অন্তগশে আইরটমগুনলে জিয <b>ডাি</b> সেুজ
এলাকাে উপে একটি ডাি আঙু ল োখুি <font color="#0000ff">rightAttribute</font>.<br/>',
' আইরটমগুরলা এক এক করে প্রিনর্শে হরে.<br/>',
'<br/>',
' আপনি যনি ভুল করেি, একটি লাল <font
color="#ff0000"><b>X</b></font> দিখা যারে। অিয নিরক স্পর্শকরুি। <u> নিভুশল থাকাকালীি আপনি যে
োডাোনড পারেি</u> যাি ',
'</p>',
'<p align="center"> শুরু কেরে <b>িীরচে </b> সেুজ এলাকা়ে
স্পর্শকরুি।</p>',
'</div>'
].join('\n'),
...
'<p style="font-size:20px; text-align:left; verticalalign:bottom; margin-left:10px; font-family:arial">' +
' কযাটাগনেে অন্তগশে আইরটমগুনলে জিয <b>E</b> কীটিরে একটি োাঁআঙু ল
োখুি৷ <font color="#336600">leftCategory</font>. ' +
'<br/> কযাটাগনেে অন্তগশে আইরটমগুনলে জিয <b>I</b> কীটিরে ডাি আঙু ল
োখুি <font color="#336600">rightCategory</font>.<br/>' +
' আইরটমগুরলা এক এক করে প্রিনর্শে হরে.<br/><br/>' +
' আপনি যনি ভুল করেি, একটি লাল <font
color="#ff0000"><b>X</b></font> দিখা যারে। ' +
' চানলর়ে দযরে অিয কী টিপুি.<br/>' +
'<u> নিভুশল থাকাকালীি আপনি যে োডাোনড পারেি</u>
...
'<br/>',
' কযাটাগনেে অন্তগশে আইরটমগুনলে জিয <b> োাঁ</b> সেুজ
এলাকা়ে একটি োাঁআঙু ল োখুি <font color="#336600">leftCategory</font>.<br/>',
' কযাটাগনেে অন্তগশে আইরটমগুনলে জিয <b>ডাি</b> সেুজ
এলাকাে উপে একটি ডাি আঙু ল োখুি <font color="#336600">rightCategory</font>.<br/>',
' আইরটমগুরলা এক এক করে প্রিনর্শে হরে। br/>',
'<br/>',
' আপনি যনি ভুল করেি, একটি লাল <font
color="#ff0000"><b>X</b></font> দিখা যারে। অিয নিরক স্পর্শকরুি। <u> নিভুশল থাকাকালীি আপনি যে
...
'<p style="font-size:20px; text-align:left; verticalalign:bottom; margin-left:10px; font-family:arial">' +
' <font color="#336600">োাঁকযাটাগনে</font> এেং এে জিয
<b>E</b> কী েযেহাে করুি <font color="#0000ff">leftAttribute</font>.<br/>' +
' <font color="#336600">ডাি কযাটাগনে </font> এেং এে জিয
<b>I</b> কী েযেহাে করুি <font color="#0000ff">rightAttribute</font>.<br/>' +
' প্রনেটি আইরটম শুধুমাত্র একটি কযাটাগনেে অন্তগশে.<br/><br/>' +
' আপনি যনি ভুল করেি, একটি লাল <font
color="#ff0000"><b>X</b></font> দিখা যারে। ' +
' চানলর়ে দযরে অিয কী টিপুি.<br/>' +
'<u> নিভুশল থাকাকালীি আপনি যে োডাোনড পারেি</u> যাি।
<br/><br/></p>' +
'<p align="center"> আপনি যখি শুরু কেরে প্রস্তুে েখি <b>দস্পস
োে</b> টিপুি। </font></p></div>',
...
'<p align="left" style="margin-left:5px">',
' <font
color="#336600">leftCategory</font> আইরটম এেং এে জিয <b>োাঁ</b> সেুজ এলাকাে উপে একটি
োম আঙু ল োখুি <font color="#0000ff">leftAttribute</font>.</br>',
' <font color="#336600"> rightCategory
</font> আইরটম এেং এে জিয <b>ডাি</b> সেুজ এলাকাে উপে ডাি আঙু ল োখুি <font
color="#0000ff">rightAttribute</font>.</br>',
' আপনি যনি ভুল করেি োহরল একটি লাল <font
color="#ff0000"><b>X</b></font> দিখা যারে। অিয নিরক স্পর্শকরুি। নিভুশল থাকাকালীি <u>যে দ্রুে
দযরে পারেি</u>.</br>','</p>',
'<p align="center"> শুরু কেরে <b>িীরচে </b> সেুজ
এলাকা়ে স্পর্শকরুি.</p>',
'</div>'
].join('\n'),
...
'<p style="font-size:20px; text-align:left; verticalalign:bottom; margin-left:10px; font-family:arial">' +
' এটি আরগে অংরর্ে মরোই.<br/>' +
' <font color="#336600">leftCategory</font> এেং এে জিয
<b>E</b> কী েযেহাে করুি <font color="#0000ff">leftAttribute</font>.<br/>' +
' <font color="#336600">rightCategory</font> এেং এে জিয
<b>I</b> কী েযেহাে করুি <font color="#0000ff">rightAttribute</font>.<br/>' +
' প্রনেটি আইরটম শুধুমাত্র একটি কযাটাগনেে অন্তগশে৷<br/><br/>' +৷
নিভুশল থাকাকালীি <u>যে দ্রুে দযরে পারেি</u>৷.<br/><br/></p>' +
'<p align="center"> আপনি যখি শুরু কেরে প্রস্তুে েখি <b>দস্পস
োে</b> টিপুি.</font></p></div>',
...
' <font
color="#336600">leftCategory</font> আইরটম এেং এে জিয <b>োাঁ</b> সেুজ এলাকাে উপে একটি
োাঁআঙু ল োখুি <font color="#0000ff">leftAttribute</font>.<br/>',
' <font
color="#336600">rightCategory</font> আইরটম এেং এে জিয <b>ডাি</b> সেুজ এলাকাে উপে
ডাি আঙু ল োখুি <font color="#0000ff">rightAttribute</font>.<br/>',
'<br/>',
'<u> নিভুশল থাকাকালীি আপনি যে োডাোনড পারেি</u>
যাি৷<br/>',
'</p>',
...
'<p style="font-size:20px; text-align:left; verticalalign:bottom; margin-left:10px; font-family:arial">' +
'<b> সােধাি, দলরেল অেস্থাি পনেেেশ ি হর়েরে!</b><br/>' +
' এে জিয <b>E</b> কী-দে োাঁআঙু ল েযেহাে করুি <font
color="#336600">leftCategory</font>.<br/>' +
' এে জিয <b>I</b> কী-দে ডাি আঙু ল েযেহাে করুি <font
color="#336600">rightCategory</font>.<br/><br/>' +
'<u> নিভুশল থাকাকালীি আপনি যে োডাোনড পারেি</u>
যাি।<br/><br/></p>' +
'<p align="center"> আপনি যখি শুরু কেরে প্রস্তুে েখি <b>দস্পস
োে</b> টিপুি.</font></p></div>',
...
'<p align="left" style="margin-left:5px">',
'<br/>',
' সােধাি, দলরেল অেস্থাি পনেেেশ ি হর়েরে!<br/>',
' একটি োাঁআঙু ল <b> োাঁ</b> সেুজ এলাকাে
উপে োখুি <font color="#336600">leftCategory</font> items.<br/>',
' এে জিয <b>ডাি</b> সেুজ এলাকাে উপে একটি
ডাি আঙু ল োখুি <font color="#336600">rightCategory</font> items.<br/>',
' আইরটম এক সমর়ে এক প্রিনর্শে হরে.',
'<br/>',
' আপনি যনি ভুল করেি োহরল একটি লাল <font
color="#ff0000"><b>X</b></font> দিখা যারে। অিয নিরক স্পর্শকরুি। নিভুশল থাকাকালীি <u>যে দ্রুে
দযরে পারেি</u>.<br/>',
...
going to use the instFirstCombined property for the third combined block as well. You
can change that.
...
suggested a strong automatic preference for categoryB over categoryA.',
fb_moderate_Att1WithCatA_Att2WithCatB : 'Your responses
suggested a moderate automatic preference for categoryB over categoryA.',
fb_slight_Att1WithCatA_Att2WithCatB : 'Your responses suggested
a slight automatic preference for categoryB over categoryA.',
...
'fb', 'bOrd'];
 ...
 {
 if(!hasProperties(logs[iLog], ['trial_id', 'name', 'responseHandle', 'stimuli',
'media', 'latency'])){
...
var rightAttName = (piCurrent.randomAttSide) ? (Math.random() >= 0.5 ?
att1.name : att2.name) : att2.name;
/**
* Create inputs
*/
var leftInput = !isTouch ? {handle:'left',on:'keypressed',key:'e'} :
{handle:'left',on:'click', stimHandle:'left'};
var rightInput = !isTouch ? {handle:'right',on:'keypressed',key:'i'} :
{handle:'right',on:'click', stimHandle:'right'};
var proceedInput = !isTouch ? {handle:'space',on:'space'} :
...
data: {score:0, parcel:'none'}, //We're using only one parcel for
computing the score, so we're always going to call it 'first'.
// set the interface for trials
input: [
{handle:'skip1',on:'keypressed', key:27}, //Esc + Enter will
skip blocks
leftInput,
rightInput
],
...
property:'corResp',negate:true}, //Not the correct response.
...
set the score to 1
{type:'showStim',handle:'error'}, // show error
stimulus
{type:'trigger',handle:'onError'} // perhaps
we need to end the trial (if no errorCorrection)
]
},
...
conditions: [
{type:'currentEquals',
property:'errorCorrection', value:false}, //no error correction.
{type:'inputEquals',value:'onError'} //Was
error
],
actions: [
{type:'removeInput',handle:'All'}, //Cannot
respond anymore
{type:'log'}, // log this trial
{type:'trigger',handle:'ITI',
duration:piCurrent.errorFBDuration} // Continue to the ITI, after that error fb has been
displayed
]
},
// correct
{
conditions: [{type:'inputEqualsTrial',
property:'corResp'}], // check if the input handle is equal to correct response (in the
trial's data object)
actions: [
{type:'removeInput',handle:'All'}, //Cannot
respond anymore
{type:'hideStim', handle: 'All'}, // hide
everything
{type:'log'}, // log this trial
{type:'trigger',handle:'ITI'} // End the trial after
ITI
]
},
...
duration:piCurrent.ITIDuration} // Continue to the ITI, after that error fb has been
displayed
]
},
// end after ITI
...
actions: [
{type:'setInput',input:{handle:'skip2',
on:'enter'}} // allow skipping if next key is enter.
]
},
// skip block: then ESC
{
...
actions: [
{type:'goto', destination: 'nextWhere',
...
data: {blockStart:true, condition:'instructions', score:0,
block:0},
...
notification
error : [{
handle:'error', location: {top: 75}, css:{color:'red','fontsize':'4em'}, media: {word:'X'}, nolog:true
}],
touchInputStimuli: [
{media:{html:'<div></div>'},
size:{height:48,width:30},css:{background:'#00FF00', opacity:0.3, zindex:-1},
location:{right:0}, data:{handle:'right'}},
{media:{html:'<div></div>'},
size:{height:48,width:30},css:{background:'#00FF00', opacity:0.3, zindex:-1},
location:{left:0}, data:{handle:'left'}}
]
});
/**
* Media Sets
...
{//params: instTemplate, blockNum, nBlocks, leftCat, rightCat, leftAtt,
rightAtt.
...
var content = layout.word || layout.html || layout.image ||
layout;
if (_.isString(layout) || layout.word) {content =
_.escape(content);}
return isImage ? '<img src="' + piCurrent.base_url.image +
content + '" />' : content;
}
...
media:{html:template},
data: {
first: buildContent(_.get(params,
'left1.title.media')),
firstCss: buildStyle(_.get(params,
'left1.title.css')),
second: buildContent(_.get(params,
'left2.title.media')),
secondCss: buildStyle(_.get(params,
'left2.title.css')),
leftKeyText : buildContent(_.get(piCurrent,
'leftKeyText')),
rightKeyText : buildContent(_.get(piCurrent,
'rightKeyText')),
keysCss : buildStyle(_.get(piCurrent,
'keysCss')),
orText : buildContent(_.get(piCurrent,
'orText')),
...
{
layout.push({
location:{bottom:1}, css:
{color:piCurrent.fontColor,'font-size':'1em'},
media : {html: isTouch ?
params.remindErrorTextTouch : params.remindErrorText}
});
}
if (!params.isInst && isTouch){
layout.push({inherit:{type:'byData', set:'touchInputStimuli',
data:{handle:'right'}}});
layout.push({inherit:{type:'byData', set:'touchInputStimuli',
data:{handle:'left'}}});
}
...
if (params.nCats == 2)
{//When there are only two categories in the block, one two of
...
inherit : 'instructions',
media : {html :
getInstFromTemplate(instParams)},
...
{//{nTrialsInMini : , currentCond : , rightTrial : , leftTrial : , blockNum : ,
blockLayout : )
var mixer = {
mixer : 'repeat',
...
data : {condition : params.currentCond, block
: params.blockNum},
...
{//{nTrialsInMini : , currentCond : , cong: , rightTrial1 : , leftTrial1 : ,
rightTrial2 : , leftTrial2 : , blockNum : , blockLayout : , parcel :)
...
mixerData.push(
{
inherit : (cats[iCat] == 1) ? params.leftTrial2 :
params.rightTrial2,
data : {condition : params.currentCond, block :
params.blockNum, parcel:params.parcel, cong:params.cong},
layout : params.blockLayout
});
iCat++;
mixerData.push(
{
inherit : (atts[iAtt] == 1) ? params.leftTrial1 :
params.rightTrial1,
data : {condition : params.currentCond, block :
params.blockNum, parcel:params.parcel, cong:params.cong},
layout : params.blockLayout
...
//Set sides
var rightCatName = (globalObj.randomBlockOrder ? (Math.random() >=
0.5 ? cat1.name : cat2.name) : cat2.name);
...
var blockCondition = blockParamsCats.left1.name + ',' +
blockParamsCats.right1.name;
blockParamsCats.nMiniBlocks =
globalObj.blockCategories_nMiniBlocks;
...
globalObj.instCategoriesPracticeTouch : globalObj.instCategoriesPractice;
var blockLayout = getLayout(blockParamsCats);
var nTrialsInMini =
blockParamsCats.nTrials/blockParamsCats.nMiniBlocks;
var iBlock2Mini;
...
if (blockParamsCats.nTrials > 0)
{
 ...
 for (iBlock2Mini = 1; iBlock2Mini <= blockParamsCats.nMiniBlocks;
iBlock2Mini++)
 {
...
blockCondition = blockParamsAtts.left1.name + ',' +
blockParamsAtts.right1.name;
...
rightCatName='+rightCatName+' att1.name='+att1.name+' cat1.name='+cat1.name +
...
globalObj.instAttributePracticeTouch : globalObj.instAttributePractice;
...
if (blockParamsAtts.nTrials > 0)
{
 ...
 for (iBlock1Mini = 1; iBlock1Mini <= blockParamsAtts.nMiniBlocks;
iBlock1Mini++)
 {
 trialSequence.push(getMiniMixer2(
 {nTrialsInMini : nTrialsInMini, currentCond : blockCondition,
...
blockCondition = blockParamsCombined.left2.name + '/' +
blockParamsCombined.left1.name + ',' + blockParamsCombined.right2.name + '/' +
...
//Number variables.
blockParamsCombined.nMiniBlocks =
globalObj.blockFirstCombined_nMiniBlocks;
...
globalObj.instFirstCombinedTouch : globalObj.instFirstCombined;
...
if (blockParamsCombined.nTrials > 0)
{
 ...
 for (iBlock3Mini = 1; iBlock3Mini <= blockParamsCombined.nMiniBlocks;
iBlock3Mini++)
 {
...
blockParamsCombined.blockNum = iBlock;
blockParamsCombined.nMiniBlocks =
globalObj.blockSecondCombined_nMiniBlocks;
blockParamsCombined.nTrials =
globalObj.blockSecondCombined_nTrials;
//Instructions trial.
blockParamsCombined.instTemplate = isTouch ?
globalObj.instSecondCombinedTouch : globalObj.instSecondCombined;
...
{
trialSequence.push(getInstTrial(blockParamsCombined));
for (iBlock4Mini = 1; iBlock4Mini <=
blockParamsCombined.nMiniBlocks; iBlock4Mini++)
{
trialSequence.push(getMiniMixer4({
nTrialsInMini : nTrialsInMini, currentCond : blockCondition,
cong:isCompatible,
...
isCompatible = (isCompatible==INCOMPATIBLE ? COMPATIBLE :
INCOMPATIBLE);
//////////////////////////////
...
blockParamsCats.instTemplate = isTouch ?
globalObj.instSwitchCategoriesTouch : globalObj.instSwitchCategories;
//Get numbers
...
blockCondition = blockParamsCats.left1.name + ',' +
blockParamsCats.right1.name;
blockParamsCats.blockNum = iBlock;
blockParamsCats.nCats = 2;
//The layout for the sorting trials.
...
{
 trialSequence.push(getInstTrial(blockParamsCats));
 for (iBlock5Mini = 1; iBlock5Mini <= blockParamsCats.nMiniBlocks;
iBlock5Mini++)
 {
 trialSequence.push(getMiniMixer2({
 nTrialsInMini : nTrialsInMini, currentCond : blockCondition,
...
{
blockParamsCombined.instTemplate = isTouch ?
globalObj.instThirdCombinedTouch : globalObj.instThirdCombined;
}
//Layout for the sorting trials.
blockLayout = getLayout(blockParamsCombined);
//Fill the trials.
...
{
 trialSequence.push(getInstTrial(blockParamsCombined));
 for (iBlock6Mini = 1; iBlock6Mini <= blockParamsCombined.nMiniBlocks;
iBlock6Mini++)
 {
 trialSequence.push(getMiniMixer4({
 nTrialsInMini : nTrialsInMini, currentCond : blockCondition,
...
{
blockParamsCombined.instTemplate = isTouch ?
globalObj.instFourthCombinedTouch : globalObj.instFourthCombined;
}
...
{
trialSequence.push(getInstTrial(blockParamsCombined));
for (iBlock7Mini = 1; iBlock7Mini <=
blockParamsCombined.nMiniBlocks; iBlock7Mini++)
{
trialSequence.push(getMiniMixer4({
nTrialsInMini : nTrialsInMini, currentCond : blockCondition,
cong:isCompatible,
...
{
inherit : 'Default',
media : {word : (isTouch ? piCurrent.finalTouchText :
piCurrent.finalText)}
}
]
});
...
extremely fast.
maxFastTrialsRate : 0.1, //Above this % of extremely fast
responses within a condition, the participant is considered too fast.
minRT : 400, //Below this latency
maxRT : 10000, //above this
errorLatency : {use:errorLatencyUse, penalty:600,
useForSTD:true},
...
var messageDef = [
{ cut:'-0.65', message :
getFB(piCurrent.fb_strong_Att1WithCatA_Att2WithCatB, cat1.name, cat2.name) },
{ cut:'-0.35', message :
getFB(piCurrent.fb_moderate_Att1WithCatA_Att2WithCatB, cat1.name, cat2.name) },
{ cut:'-0.15', message :
getFB(piCurrent.fb_slight_Att1WithCatA_Att2WithCatB, cat1.name, cat2.name) },
{ cut:'0.15', message :
getFB(piCurrent.fb_equal_CatAvsCatB, cat1.name, cat2.name) },
{ cut:'0.35', message :
getFB(piCurrent.fb_slight_Att1WithCatA_Att2WithCatB, cat2.name, cat1.name) },
{ cut:'0.65', message :
getFB(piCurrent.fb_moderate_Att1WithCatA_Att2WithCatB, cat2.name, cat1.name) },
{ cut:'5', message :
getFB(piCurrent.fb_strong_Att1WithCatA_Att2WithCatB, cat2.name, cat1.name) }
];
